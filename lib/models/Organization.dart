...
class Organization {
  ...
  Organization(
      this.logo, this.coverImage, this.name, this.members, this.projects);

  static List<Organization> getOrganizationData() {
    return [
      new Organization(
          "https://drive.google.com/uc?export=view&id=1sddC8XpVHlIqBjQHcHQq47HaGdlN1GYG",
          "https://drive.google.com/uc?export=view&id=1dfNjHK47DH0n0fVuGpecjNxibRor4p3w",
          "Connecting",
          Member.getMembers().sublist(0, 3),
          Project.getProjectsList().sublist(0, 2)),
      new Organization(
          ...
          Project.getProjectsList().sublist(0, 4)),
      new Organization(
          "https://drive.google.com/uc?export=view&id=1ra8l1DXy9g0wi6dEeDbxDyMlJmO5YA0u",
          "https://drive.google.com/uc?export=view&id=1w33Bwsu-vC-CUHen6wMg-cq4-uIRNJw2",
          "xLines",
          Member.getMembers().sublist(4, 7),
          Project.getProjectsList().sublist(1, 4)),
    ];
  }
}
