...
import 'package:scrum_it/screens/ProjectDetails.dart';
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: Colors.grey[100], blurRadius: 10, spreadRadius: 5)
            ]),
        child: Column(
                    ...
                    Flexible(
                      ...
                      child: Align(
                          ...
                          child: NotificationIcon(
                            ...
                            21,
                            '11',
                            Utils.getColorFromHex(project.color),
                          )),
                    ),
                  ],
                ),
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: new BoxDecoration(
                      color:
                          Utils.getColorFromHex(project.color).withOpacity(0.3),
                    ),
                  ),
                  Positioned(
                    child: Container(
